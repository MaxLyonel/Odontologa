...
export class init1696805181266 implements MigrationInterface {
    name = 'init1696805181266'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "active" boolean NOT NULL, "personId" integer, CONSTRAINT "REL_6aac19005cea8e2119cbe7759e" UNIQUE ("personId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_role" ("id" SERIAL NOT NULL, "userId" integer, "rolId" integer, CONSTRAINT "PK_fb2e442d14add3cefbdf33c4561" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_role" ADD CONSTRAINT "FK_b47e14b1b80c230f5fbfd4abd95" FOREIGN KEY ("rolId") REFERENCES "role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_role" DROP CONSTRAINT "FK_b47e14b1b80c230f5fbfd4abd95"`);
